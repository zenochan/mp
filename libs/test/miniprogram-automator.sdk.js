...
var ZzTester = /** @class */ (function () {
    ...
    ZzTester.connect = function (port) {
        if (port === void 0) { port = 9420; }
        return automator.connect({ wsEndpoint: "ws://localhost:" + port });
    };
    ZzTester.prototype.connect = function (port) {
        if (port === void 0) { port = 9420; }
        return automator.connect({ wsEndpoint: "ws://localhost:" + port });
    };
    ...
    ZzTester.prototype.tap = function (selector) {
        return this.app.currentPage()
            .then(function (page) { return page.$(selector); })
            .then(function (el) { return el.tap(); });
    };
...
exports.default = ZzTester;
//# sourceMappingURL=miniprogram-automator.sdk.js.map