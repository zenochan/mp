...
export function drawCharts(chart: WxCharts, type, opts, config, context) {
  ...
  switch (type) {
    case 'line':
      chart.animationInstance = new ChartAnimation({
        timing: 'easeIn',
        duration: duration,
        onProcess: (process) => {
      ...
      break;
    case 'column':
      this.animationInstance = new ChartAnimation({
        timing: 'easeIn',
        duration: duration,
        onProcess: (process) => {
          drawYAxisGrid(opts, config, context);
    ...
    case 'pie':
      this.animationInstance = new ChartAnimation({
        ...
        duration: duration,
        onProcess: (process) => {
          chart.chartData.pieData = drawPieDataPoints(series, opts, config, context, process);
          drawLegend(opts.series, opts, config, context);
          drawCanvas(opts, context);
        },
        onAnimationFinish: () => {
