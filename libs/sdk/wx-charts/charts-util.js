...
exports.calValidDistance = calValidDistance;
...
exports.isInAngleRange = isInAngleRange;
...
exports.calRotateTranslate = calRotateTranslate;
...
exports.createCurveControlPoints = createCurveControlPoints;
...
exports.convertCoordinateOrigin = convertCoordinateOrigin;
function avoidCollision(obj, target) {
    if (target) {
        // is collision test
        while (util_1.Util.isCollision(obj, target)) {
            if (obj.start.x > 0) {
                obj.start.y--;
            }
...
exports.avoidCollision = avoidCollision;
...
exports.fillSeriesColor = fillSeriesColor;
